// Inline SVG Icon System — replaces emojis with clean Lucide-style vector icons
// Each icon is a 24x24 viewBox, stroke-based SVG path
// Usage: ICON('name', size, color) returns SVG markup string

var ICONS = {
  // Regions
  'beach': '<path d="M17.7 7.7a7.5 7.5 0 1 0-11.4 0"/><path d="M2 17h20"/><path d="M2 21h20"/><path d="M12 12v5"/>',
  ...
  'rocking-chair': '<polyline points="3.5 2 6.5 12.5 18 12.5"/><line x1="9.5" y1="12.5" x2="5.5" y2="20"/><line x1="15" y1="12.5" x2="18.5" y2="20"/><path d="M2.75 18a13 13 0 0 0 18.5 0"/>',
  'palmtree': '<path d="M13 8c0-2.76-2.46-5-5.5-5-1.93 0-3.5 1.57-3.5 3.5S5.57 10 7.5 10H13V8z"/><path d="M13 7.14A5.82 5.82 0 0 1 16.5 6c3.04 0 5.5 2.24 5.5 5H13V7.14z"/><path d="M11 22v-6"/><path d="M13 22v-6"/>',
  ...
  'hammer': '<path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9"/><path d="M17.64 15 22 10.64"/><path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25V6.5L14.5 2.24a.5.5 0 0 0-.85.35V6.5c0 .71-.28 1.39-.78 1.89L12 9.32"/>',
  ...
  'trees': '<path d="M10 10v.2A3 3 0 0 1 8.9 16H5a3 3 0 0 1-1-5.8V10a3 3 0 0 1 6 0z"/><path d="M7 16v6"/><path d="M13 19v3"/><path d="M16 13v.2A3 3 0 0 1 14.9 19H11a3 3 0 0 1-1-5.8V13a3 3 0 0 1 6 0z"/>',
